...
<div id="wrapper">
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Create Folder for video</h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		...
		<div class="panel panel-info">
			<div class="panel panel-heading" style="text-align: center">
				Create Folder <a class="btn btn-default" href="<?=site_url()?>admin_gallery/video" style="float: right;margin-top: -8px;">Back</a>
			</div>
				...
				<form action="<?=site_url()?>admin_gallery/folder_action" method="post" enctype="multipart/form-data" class="form-inline" style="">
					<table  border="0" cellspacing="0" cellpadding="5">
						...
						<div style=" margin-left: 30px;">
							<input type="hidden" value="video" name="cat">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
							...
							$sql="select * from gallery_video WHERE gid=$id";
							...
							if(count($cou)) {
								...
								echo '<tr>
									  ...
									  <td style=" "><span class="btn btn-success btn-sm">' . count($cou) . ' Videos</span></td>
									   <td style=""> <a href="' . site_url() . 'admin_gallery/edit_folder1/' . $id . '/' . $cat . '"  class="btn btn-warning btn-sm" >Edit</a></td>
                                      <td style=""> <a  data-href="' . site_url() . 'admin_gallery/del_folder/' . $id . '/' . $cat . '" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#confirm-delete"><span data-toggle="tooltip "  data-placement="right" data-original-title="This folder contains  '. count($cou) .'  Videos">Delete</span></a></td></tr>';
							}else{
								echo '<tr>
                                      <td>' . $sno . '</td>
                                      <td style="text-align: center">' . $first_name . '</td>
									  <td style=" "><img src=' . base_url() . $folder_image . ' height="50" width="50"/></td>
									  <td style=" "><span class="btn btn-warning btn-sm">Empty folder</span></td>
									   <td style=""> <a href="' . site_url() . 'admin_gallery/edit_folder1/' . $id . '/' . $cat . '"  class="btn btn-warning btn-sm" >Edit</a></td>
                                      <td style=""> <a  data-href="' . site_url() . 'admin_gallery/del_folder/' . $id . '/' . $cat . '" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#confirm-delete"><span data-toggle="tooltip "  data-placement="right" data-original-title="This is empty folder">Delete</span></a></td></tr>';
