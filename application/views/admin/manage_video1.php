...
<head>
	...
	<title>Gallery/Manage Video</title>
	...
	<div id="page-wrapper">
		...
		<div class="panel panel-info">
			<div class="panel panel-heading" style="text-align: center">
				Manage video <a class="btn btn-default" href="<?=site_url()?>admin_gallery/video" style="float: right;margin-top: -8px;">Back</a>
			</div>
			<div class="panel panel-body" style="text-align: center">
				...
				<form class="form-inline" action="<?=site_url()?>admin_gallery/manage_video1" enctype="multipart/form-data" method="post">
					...
					<div class="panel-body">
						<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
							...
							foreach($ro as $row)
							{
								...
								echo '<tr>
                                      <td>'.$sno.'</td>                                   
									  <td style=" "><video height="50" width="70" autoplay/>
									  <source src="'.base_url().'/'.$video.'" type="video/mp4">
                                      <source src="'.base_url().'/'.$video.'" type="video/avi">
                                      <source src="'.base_url().'/'.$video.'" type="video/3gp">
									  </video></td>
									  <td style="text-align: center">'.$select_folder.'</td>
									  <td style="text-align: center">'.$title.'</td>
									  <td style="text-align: center">'.$update_date.'</td>
									   <td style=""> <a href="'.site_url().'admin_gallery/manage_video_edit/'.$id.'"  class="btn btn-warning btn-sm" >Edit</a></td>
                                      <td style=""> <a  data-href="'.site_url().'admin_gallery/manage_video_del/'.$id.'/'.$select_folder.'" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#confirm-delete">Delete</a></td></tr>';
								$sno++;
							}
							?>
							</tbody>
