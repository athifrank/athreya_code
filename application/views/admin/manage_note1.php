...
<div id="wrapper">
	...
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Manage Note</h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		...
		<div class="panel panel-info">
			<div class="panel panel-heading" style="text-align: center">
				Manage Note <a class="btn btn-default" href="<?=site_url()?>admin_note" style="float: right;margin-top: -8px;">Back</a>
			</div>
			<div class="panel panel-body" style="text-align: center">
				...
				<form class="form-inline" action="<?=site_url()?>admin_note/manage_note1" enctype="multipart/form-data" method="post">
							...
							foreach($ro as $row)
							{
								...
								echo '<tr>
									  ...
									  <td style="text-align: center">'.$desc.'</td>
									   <td style=""> <a href="'.site_url().'admin_note/manage_note_edit/'.$id.'"  class="btn btn-warning btn-sm" >Edit</a></td>
                                      <td style=""> <a  data-href="'.site_url().'admin_note/manage_note_del/'.$id.'/'.$select_folder.'" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#confirm-delete">Delete</a></td></tr>';
								$sno++;
							}
							?>
							</tbody>
